...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getAllProducts() {
        ...
        product1.setId(2);
        product1.setName("Теория каст и ролей");
        product1.setPrice(29.0);
        product1.setDescription("Революционная книга, в которой автор делит общество на касты и описывает роли людей в них.");
        product1.setFullDescription("Революционная книга, в которой автор делит общество на касты и описывает роли людей в них.\n" +
                "\n" +
        ...
        product1.setImage("9781451648539.jpg");
        product1.setNovelty(false);
