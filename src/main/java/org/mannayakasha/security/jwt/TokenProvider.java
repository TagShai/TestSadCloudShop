package org.mannayakasha.security.jwt;
...
import org.mannayakasha.config.AppConfig;
...
public class TokenProvider {
    ...
    public TokenProvider(AppConfig config, UserDetailsService userService) {
        ...
        this.tokenValidityInMilliseconds = 60;//1000 * config.getTokenValidityInSeconds();
